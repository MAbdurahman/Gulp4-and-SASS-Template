! function(t, e) {
    ...
    return function(t) {
        ...
        t.exports = (t, e = {}) => {
            ...
            return window.onload = r.onScroll(), window.addEventListener("scroll", () => r.onScroll()), r
        }
    }, function(t, e, o) {
        "use strict";
        ...
        class n {
            ...
            getSectionInView() {
                for (let t = 0; t < this.sections.length; t++) {
                    const e = this.sections[t].offsetTop,
                        ...
                        n = (document.documentElement.scrollTop || document.body.scrollTop) + this.options.offset;
            ...
            removeCurrentActive({
                ...
                const {
                    hrefAttribute: e,
                    menuActiveTarget: o
                } = this.options, n = `${o}.active:not([${e}="${t.getAttribute(e)}"])`;
                this.menuList.querySelectorAll(n).forEach(t => t.classList.remove(this.options.activeClass))
            }
        }
    }])
}));